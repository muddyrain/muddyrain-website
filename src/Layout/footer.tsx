...
export const Footer: FC = () => {
  return (
    <Stack spacing={1} className="flex flex-col items-center pt-10 pb-12 justify-center">
      <Typography variant="h5">加入我们的学习吧！</Typography>
      <Typography variant="body2" color="text.secondary">
        任何时候我也不会满足，越是读书，就越是深刻的感到不满足，越是感到自己的知识贫乏。—— 马克思
      </Typography>
      ...
      <div className="text-zinc-400">
        <span className="text-purple-500">Muddyrain</span> © . All rights reserved.
